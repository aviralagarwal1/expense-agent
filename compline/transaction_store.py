...
from .transactions import normalize_status, normalize_vendor
...
def delete_all_transactions_for_user(client, user_id: str):
    return client.table("transactions").delete().eq("user_id", user_id).execute()
